...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#050b14] text-white selection:bg-[#005baa]/40 selection:text-white font-sans antialiased">
      {/* ─── Background Ambient Glows & Grid Lines ──────────────────────── */}
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        {/* Ambient UP Blue Radial Glow Top Center */}
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-[600px] w-[900px] rounded-full bg-gradient-to-b from-[#005baa]/35 via-[#00457f]/25 to-transparent blur-3xl" />
        {/* Secondary Ochre Accent Glow */}
        <div className="absolute top-1/3 -right-40 h-[500px] w-[500px] rounded-full bg-[#b45309]/20 blur-3xl" />
        ...
        <video
          ...
          muted
          playsInline
          className="h-full w-full object-cover opacity-20 mix-blend-screen pointer-events-none"
          src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260508_064122_c4750c0e-7476-4b44-94a2-a85a65c63bf2.mp4"
        />
      </div>

      {/* Guide lines */}
      <div className="hidden md:block pointer-events-none fixed inset-y-0 left-1/2 -translate-x-[calc(50%+36rem)] w-px bg-white/15 z-[5]" />
      <div className="hidden md:block pointer-events-none fixed inset-y-0 left-1/2 translate-x-[calc(-50%+36rem)] w-px bg-white/15 z-[5]" />

      {/* ─── Navigation Header ────────────────────────────────────────── */}
      <header className="sticky top-0 z-50 border-b border-white/20 bg-[#050b14]/95 backdrop-blur-2xl transition-all shadow-lg">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="min-w-0">
              <span className="text-xs font-black uppercase tracking-[0.2em] text-[#7cc2ff]">
                University of Pretoria
              </span>
              <p className="text-sm font-extrabold tracking-tight text-white group-hover:text-[#b0d8ff] transition-colors">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-white">
            <a href="#about" className="hover:text-[#7cc2ff] transition-colors">
              Workspace Overview
            </a>
            <a href="#dsa-units" className="hover:text-[#7cc2ff] transition-colors">
              DSA Units
            </a>
            <a href="#coaches" className="hover:text-[#7cc2ff] transition-colors">
              ASC Directory
            </a>
            <a href="#chatbot-sync" className="hover:text-[#7cc2ff] transition-colors">
              Leaf Chatbot Sync
            </a>
          </nav>
      ...
      <section className="relative z-10 pt-20 md:pt-28 pb-20 text-center flex flex-col items-center max-w-5xl mx-auto px-6">
        {/* Eyebrow Pill */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#005baa] bg-[#005baa]/30 px-5 py-2 text-xs font-extrabold text-[#dcecf8] backdrop-blur-md mb-8 shadow-md">
          <GraduationCap size={16} className="text-[#7cc2ff]" />
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.08] text-white drop-shadow-lg">
          ...
          <br />
          <span className="text-[#7cc2ff] font-black drop-shadow-md">
            Instant knowledge for Leaf Chatbot.
          </span>
        </h1>

        {/* Hero Subtitle - High Contrast */}
        <p className="mt-8 text-lg sm:text-xl text-slate-100 max-w-2xl leading-relaxed font-semibold drop-shadow-sm">
          Update <strong className="text-white font-black underline decoration-[#005baa] decoration-2 underline-offset-4">Academic Success Coaches</strong> details,{" "}
          <strong className="text-white font-black underline decoration-[#005baa] decoration-2 underline-offset-4">Department of Student Affairs (DSA)</strong> units, and{" "}
          <strong className="text-white font-black underline decoration-[#005baa] decoration-2 underline-offset-4">General UP Guidelines</strong> in one central console.
          Every change automatically updates the <strong className="text-[#7cc2ff] font-black">Leaf chatbot</strong> so UP students get instant, accurate assistance.
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            href="#chatbot-sync"
            className="inline-flex items-center justify-center gap-2 rounded-full border border-white/40 bg-white/15 text-white font-bold text-sm px-7 py-4 backdrop-blur-md transition-all hover:bg-white/25"
          >
            <Database size={16} className="text-[#7cc2ff]" />
            <span>How Leaf Chatbot Sync Works</span>
          </a>
        </div>

        {/* Security badge */}
        <p className="mt-5 text-xs font-bold text-slate-200 flex items-center gap-1.5 justify-center">
      ...
      <section id="chatbot-sync" className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="rounded-2xl border border-white/25 bg-[#08121e]/98 backdrop-blur-2xl shadow-[0_24px_80px_rgba(0,32,80,0.6)] overflow-hidden">
          {/* macOS Titlebar */}
          <div className="h-10 bg-black/60 border-b border-white/15 px-4 flex items-center justify-between text-xs text-white">
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-[#ff5f57]" />
              <span className="w-3 h-3 rounded-full bg-[#febc2e]" />
              <span className="w-3 h-3 rounded-full bg-[#28c840]" />
              <span className="ml-3 font-mono text-[12px] font-bold text-white">
                UP Admin Console ──► Leaf Chatbot Realtime Pipeline
              </span>
            </div>
            <div className="flex items-center gap-2 font-mono text-[11px] text-[#7cc2ff]">
          ...
          <div className="grid lg:grid-cols-12 min-h-[460px]">
            ...
            <div className="lg:col-span-7 p-6 sm:p-8 border-b lg:border-b-0 lg:border-r border-white/15 space-y-6">
              <div className="flex items-center justify-between">
                <span className="text-xs font-extrabold uppercase tracking-wider text-[#7cc2ff] flex items-center gap-2">
                  <LayoutDashboard size={15} />
                  Content Management Workspace
                </span>
                <span className="text-xs text-white font-mono font-bold">Step 1: Admin Update</span>
              </div>

              <div className="space-y-4">
                {/* Demo Record Item 1: ASC Coach */}
                <div className="rounded-xl border border-white/20 bg-white/10 p-4 space-y-2 transition hover:border-[#005baa]">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-extrabold text-white flex items-center gap-2">
                      <Users size={15} className="text-[#7cc2ff]" />
                      ASC Coach Directory Record
                    </span>
                    <span className="rounded-full bg-emerald-500/30 text-emerald-200 border border-emerald-400/50 px-2 py-0.5 text-[10px] font-black">
                      UPDATED
                    </span>
                  </div>
                ...
                <div className="rounded-xl border border-white/20 bg-white/10 p-4 space-y-2 transition hover:border-[#005baa]">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-extrabold text-white flex items-center gap-2">
                      <HeartPulse size={15} className="text-[#7cc2ff]" />
                ...
                <div className="rounded-xl border border-white/20 bg-white/10 p-4 space-y-2 transition hover:border-[#005baa]">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-extrabold text-white flex items-center gap-2">
                      <Building2 size={15} className="text-[#7cc2ff]" />
                      General UP Guidelines
                    </span>
                    <span className="rounded-full bg-[#005baa]/50 text-[#b0d8ff] border border-[#005baa] px-2 py-0.5 text-[10px] font-black">
              ...
              {/* Sync Receipt Bar */}
              <div className="rounded-xl border border-[#005baa] bg-[#005baa]/25 p-3.5 flex items-center justify-between text-xs text-[#b0d8ff]">
                <div className="flex items-center gap-2 font-bold">
                  <RefreshCw size={15} className="animate-spin text-[#7cc2ff]" />
                  <span>Vector Knowledge Sync: <strong>3 Records Processed</strong></span>
                </div>
                <span className="font-mono text-[11px] font-bold text-white">Receipt #req-up-8842</span>
              </div>
            </div>

            {/* Right: Leaf Chatbot Live Output (5 cols) */}
            <div className="lg:col-span-5 bg-black/60 p-6 sm:p-8 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
      ...
      <section id="about" className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-100 font-bold drop-shadow-sm">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-20 border-t border-white/15">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-xs font-black uppercase tracking-[0.2em] text-[#7cc2ff]">
          ...
          <p className="text-base sm:text-lg text-slate-100 font-bold">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Step 1 */}
          <div className="rounded-2xl border border-white/20 bg-[#0e1724]/75 p-6 space-y-3 relative shadow-md">
            <span className="text-3xl font-black text-[#7cc2ff]">01</span>
            <h4 className="text-lg font-black text-white">Admin Record Edit</h4>
          ...
          {/* Step 2 */}
          <div className="rounded-2xl border border-white/20 bg-[#0e1724]/75 p-6 space-y-3 relative shadow-md">
            <span className="text-3xl font-black text-[#7cc2ff]">02</span>
            <h4 className="text-lg font-black text-white">Validation & Audit</h4>
            <p className="text-xs text-slate-100 leading-relaxed font-semibold">
          ...
          {/* Step 3 */}
          <div className="rounded-2xl border border-white/20 bg-[#0e1724]/75 p-6 space-y-3 relative shadow-md">
            <span className="text-3xl font-black text-[#7cc2ff]">03</span>
            <h4 className="text-lg font-black text-white">Vector Store Sync</h4>
            <p className="text-xs text-slate-100 leading-relaxed font-semibold">
          ...
          {/* Step 4 */}
          <div className="rounded-2xl border border-white/20 bg-[#0e1724]/75 p-6 space-y-3 relative shadow-md">
            <span className="text-3xl font-black text-[#7cc2ff]">04</span>
            <h4 className="text-lg font-black text-white">Leaf Resolution</h4>
            <p className="text-xs text-slate-100 leading-relaxed font-semibold">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="rounded-3xl border border-white/20 bg-gradient-to-r from-[#005baa]/35 via-[#0e1724] to-[#005baa]/35 p-8 backdrop-blur-xl shadow-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-3xl sm:text-5xl font-black text-white">9</p>
              <p className="text-xs font-black uppercase tracking-wider text-[#7cc2ff] mt-1">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
        <div className="rounded-3xl border border-[#005baa] bg-gradient-to-b from-[#005baa]/35 to-[#0e1724] p-10 sm:p-16 backdrop-blur-2xl relative overflow-hidden shadow-2xl">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,91,170,0.4),transparent_70%)] pointer-events-none" />

          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white drop-shadow-md relative z-10">
            Keep UP support content synchronized.
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-100 max-w-xl mx-auto font-bold relative z-10">
      ...
      {/* ─── Footer ──────────────────────────────────────────────────── */}
      <footer className="relative z-10 border-t border-white/20 bg-[#040810] py-12 text-xs text-white">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-6 text-slate-100 font-bold">
            <Link href="/admin/faculties" className="hover:text-[#7cc2ff] transition-colors">
              Faculties
            </Link>
            <Link href="/admin/coaches" className="hover:text-[#7cc2ff] transition-colors">
              ASC Coaches
            </Link>
            <Link href="/admin/resources" className="hover:text-[#7cc2ff] transition-colors">
              Resources & DSA
            </Link>
            <Link href="/admin/faqs" className="hover:text-[#7cc2ff] transition-colors">
              FAQs
            </Link>
          </div>
