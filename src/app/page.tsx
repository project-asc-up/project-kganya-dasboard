  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#070d14] text-white selection:bg-[#005baa]/30 selection:text-white font-sans antialiased">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-[600px] w-[900px] rounded-full bg-gradient-to-b from-[#005baa]/30 via-[#00457f]/20 to-transparent blur-3xl" />
        {/* Secondary Ochre Accent Glow */}
        <div className="absolute top-1/3 -right-40 h-[500px] w-[500px] rounded-full bg-[#b45309]/15 blur-3xl" />
      ...
      {/* ─── Navigation Header ────────────────────────────────────────── */}
      <header className="sticky top-0 z-50 border-b border-white/15 bg-[#070d14]/90 backdrop-blur-xl transition-all">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-bold tracking-tight text-white group-hover:text-[#b0d8ff] transition-colors">
      ...
      <section className="relative z-10 pt-20 md:pt-28 pb-20 text-center flex flex-col items-center max-w-5xl mx-auto px-6">
        {/* Eyebrow Pill */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#005baa]/60 bg-[#005baa]/20 px-4.5 py-2 text-xs font-bold text-[#b0d8ff] backdrop-blur-md mb-8 shadow-md">
          <GraduationCap size={16} className="text-[#3d84c2]" />
          <span>Official Academic & Student Affairs Content Console</span>
        </div>

        {/* Headline with High Contrast Visibility */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.05] text-white drop-shadow-md">
          One workspace for UP support.
          <br />
          <span className="text-[#3d84c2] font-black">
            Instant knowledge for Leaf Chatbot.
          </span>
        </h1>

        {/* Hero Paragraph */}
        <p className="mt-8 text-lg text-white/85 max-w-2xl leading-relaxed font-medium">
          Update <strong className="text-white font-bold">Academic Success Coaches</strong> details,{" "}
          <strong className="text-white font-bold">Department of Student Affairs (DSA)</strong> units, and{" "}
          <strong className="text-white font-bold">General UP Guidelines</strong> in one central console.
          Every change automatically updates the <strong className="text-[#b0d8ff] font-bold">Leaf chatbot</strong> so UP students get instant, accurate assistance.
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Show when="signed-out">
            <Link
              href="/sign-in"
              className="group inline-flex items-center justify-center gap-2.5 rounded-full bg-[#005baa] text-white font-bold text-sm px-8 py-3.5 shadow-xl transition-all hover:bg-[#00457f] hover:scale-105 active:scale-[0.98]"
            >
          ...
          <a
            href="#chatbot-sync"
            className="inline-flex items-center justify-center gap-2 rounded-full border border-white/30 bg-white/10 text-white font-semibold text-sm px-6 py-3.5 backdrop-blur-md transition-all hover:bg-white/20"
          >
            <Database size={16} className="text-[#3d84c2]" />
            <span>How Leaf Chatbot Sync Works</span>
          </a>
        </div>

        {/* Security badge */}
        <p className="mt-4 text-xs font-semibold text-white/50 flex items-center gap-1.5 justify-center">
      ...
      <section id="chatbot-sync" className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="rounded-2xl border border-white/20 bg-[#0b1420]/95 backdrop-blur-2xl shadow-[0_24px_80px_rgba(0,32,80,0.5)] overflow-hidden">
          {/* macOS Titlebar */}
          <div className="h-10 bg-black/50 border-b border-white/10 px-4 flex items-center justify-between text-xs text-white/60">
            ...
            <div className="flex items-center gap-2 font-mono text-[11px] text-[#3d84c2]">
              ...
              <span className="font-bold">LIVE AUTOMATED SYNC ACTIVE</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 min-h-[460px]">
            ...
            <div className="lg:col-span-7 p-6 sm:p-8 border-b lg:border-b-0 lg:border-r border-white/10 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-white/50 font-mono">Step 1: Admin Update</span>
              </div>

              <div className="space-y-4">
                {/* Demo Record Item 1: ASC Coach */}
                <div className="rounded-xl border border-white/15 bg-white/5 p-4 space-y-2 transition hover:border-[#005baa]">
                ...
                <div className="rounded-xl border border-white/15 bg-white/5 p-4 space-y-2 transition hover:border-[#005baa]">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="rounded-full bg-[#005baa]/40 text-[#b0d8ff] border border-[#005baa]/60 px-2 py-0.5 text-[10px] font-bold">
              ...
              {/* Sync Receipt Bar */}
              <div className="rounded-xl border border-[#005baa]/50 bg-[#005baa]/15 p-3.5 flex items-center justify-between text-xs text-[#b0d8ff]">
            ...
            <div className="lg:col-span-5 bg-black/50 p-6 sm:p-8 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-white/50">Step 2: Realtime Student Answer</span>
                </div>

                {/* Simulated Student Query */}
                <div className="flex justify-end">
                  <div className="max-w-[85%] rounded-2xl rounded-tr-xs bg-[#005baa] px-4 py-3 text-xs text-white font-medium shadow-md">
                ...
                <div className="flex justify-start">
                  <div className="max-w-[90%] space-y-2.5 rounded-2xl rounded-tl-xs border border-white/15 bg-white/10 p-4 text-xs text-white backdrop-blur-md">
                    <div className="flex items-center gap-2 font-bold text-[#b0d8ff]">
                    ...
                    <ul className="space-y-1.5 text-white/90 pl-3 list-disc font-medium">
                      <li>
                    ...
                    <div className="pt-2 border-t border-white/10 text-[10px] text-white/60 flex items-center gap-1.5 font-medium">
              ...
              {/* Bot status footer */}
              <div className="text-center text-xs text-white/50 pt-4 border-t border-white/10 font-medium">
      ...
      <section id="about" className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="group rounded-3xl border border-white/15 bg-[#0e1724]/70 p-8 transition-all hover:border-[#005baa] hover:bg-[#0e1724]/95 hover:-translate-y-1 backdrop-blur-xl">
            <div className="h-12 w-12 rounded-2xl bg-[#005baa]/25 text-[#3d84c2] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <Users size={24} />
            </div>
            ...
            <ul className="space-y-2.5 text-xs text-white/90 font-semibold">
              <li className="flex items-center gap-2">
                <CheckCircle2 size={15} className="text-[#3d84c2]" />
          ...
          <div id="dsa-units" className="group rounded-3xl border border-white/15 bg-[#0e1724]/70 p-8 transition-all hover:border-[#005baa] hover:bg-[#0e1724]/95 hover:-translate-y-1 backdrop-blur-xl">
            <div className="h-12 w-12 rounded-2xl bg-[#005baa]/25 text-[#3d84c2] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <HeartPulse size={24} />
            </div>
            <h3 className="text-2xl font-extrabold text-white mb-3 tracking-tight">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-20 border-t border-white/10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Step 1 */}
          <div className="rounded-2xl border border-white/15 bg-[#0e1724]/50 p-6 space-y-3 relative">
          ...
          <div className="rounded-2xl border border-white/15 bg-[#0e1724]/50 p-6 space-y-3 relative">
            ...
            <h4 className="text-base font-bold text-white">Vector Store Sync</h4>
            <p className="text-xs text-white/70 leading-relaxed font-medium">
          ...
          <div className="rounded-2xl border border-white/15 bg-[#0e1724]/50 p-6 space-y-3 relative">
            ...
            <h4 className="text-base font-bold text-white">Leaf Resolution</h4>
            <p className="text-xs text-white/70 leading-relaxed font-medium">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="rounded-3xl border border-white/15 bg-gradient-to-r from-[#005baa]/25 via-[#0e1724] to-[#005baa]/25 p-8 backdrop-blur-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-3xl sm:text-4xl font-black text-white">9</p>
              <p className="text-xs font-bold uppercase tracking-wider text-[#3d84c2] mt-1">
                UP Faculties Covered
              </p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-black text-[#b0d8ff]">6</p>
              <p className="text-xs font-bold uppercase tracking-wider text-[#3d84c2] mt-1">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
        <div className="rounded-3xl border border-[#005baa]/50 bg-gradient-to-b from-[#005baa]/25 to-[#0e1724] p-10 sm:p-16 backdrop-blur-2xl relative overflow-hidden shadow-2xl">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,91,170,0.3),transparent_70%)] pointer-events-none" />
          ...
          <p className="mt-4 text-base text-white/80 max-w-xl mx-auto font-medium relative z-10">
      ...
      {/* ─── Footer ──────────────────────────────────────────────────── */}
      <footer className="relative z-10 border-t border-white/10 bg-[#05090f] py-12 text-xs text-white/60">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-semibold text-white/80">University of Pretoria · Academic Support Console</span>
          </div>
